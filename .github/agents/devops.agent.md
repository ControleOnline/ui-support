---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-support, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-support`.
...
- Checkout local: `app-community/modules/controleonline/ui-support`
